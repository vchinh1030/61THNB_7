...
<body>
    <div class="wrapper container">
        ...
        <h1 class="text-center my-3">Đăng ký</h1>
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <?php echo (form_error('username') != "") ? 'is-invalid' : '';?>" name="username" id="userName" value="<?php echo set_value('username')?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control 
                <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname" id="lastName" value="<?php echo set_value('lastname')?>">
                ...
                <?php echo (form_error('password') != "") ? 'is-invalid' : '';?>" name="password" id="pass" value="<?php echo set_value('password')?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control
                <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName" value="<?php echo set_value('firstname')?>">
        ...
        <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>"
            ...
            <p>Bạn đã có tài khoản? <a href="<?php echo base_url().'login/index';?>">Đăng nhập ngay !</a></p>
        </form>
    </div>
