...
<body>
    <div class="wrapper mt-sm-5">
        ...
        ?>
        <h4 class="pb-4 border-bottom text-center">Đăng nhập</h4>
        <form action="<?php echo base_url().'login/authenticate' ;?>" name="loginform" id="loginform" method="POST">
            ...
            <div class="py-3 pb-4 border-bottom">
                <button type="submit" class="btn btn-success mr-3">Đăng nhập</button>
                <a href="<?php echo base_url().'singup/index' ?>" class="btn btn-danger">Đăng ký</a>
            </div>
        </form>
    </div>
    <script>
