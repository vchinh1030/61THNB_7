            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('tensanpham') != "") ? 'is-invalid' : '';?>" name="tensanpham" id="name"
                        placeholder="Nhập tên sản phẩm" value="<?php echo set_value('name'); ?>">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('giatien') != "") ? 'is-invalid' : '';?>" id="price" name="giatien"
                        placeholder="Nhập giá tiền $" value="<?php echo set_value('price'); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('thongtinsanpham') != "") ? 'is-invalid' : '';?>" id="about" name="thongtinsanpham"
                        placeholder="Nhập thông tin" value="<?php echo set_value('about'); ?>">
